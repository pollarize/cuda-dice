...
//Local variables
char aCharArrayL[cStringArrayMax];
...
const uint8_t* CalculateSHA3(const char * pCharArrayP, uint8_t u8SizeP)
{
	sha3_context c;
	uint8_t* pU8HashL;
...
uint8_t* StringToHex(uint8_t* pCharArrayP, uint8_t u8CountOfBytesP)
{
	int i;
